...
tf.flags.DEFINE_string("neutral_data_file", "./data/neutral.txt", "Data source for the negative data.")

tf.flags.DEFINE_string("negative_data_file", "./data/negative.txt", "Data source for the neutral data.")
