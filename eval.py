...
tf.flags.DEFINE_string("neutral_data_file", "./data1/Test/neutral.txt", "Data source for the negative data.")

# Eval Parameters
tf.flags.DEFINE_integer("batch_size", 64, "Batch Size (default: 64)")
tf.flags.DEFINE_string("checkpoint_dir", "./runs/1551497820/", "Checkpoint directory from training run")
tf.flags.DEFINE_string("checkpoint_path", "./runs/1551497820/checkpoints", "Checkpoint directory from training result")
...
while True:
	...
	pre_comment=data_helpers.stopword(pre_comment)
	x_raw = [pre_comment]
	...
	# elif data_helpers.neg_word(pre_comment) :
    # 		print("neutral")
	elif batch_predictions==[0] and data_helpers.neg_word(pre_comment) :  
		print("Comment of you: " + str(comment))
		print("Positive !!!")
        # if data_helpers.neg_word(pre_comment) :
    	# 	print("Neutral !!!")
		# else :
		# 	print("Negative !!!")
	elif batch_predictions==[0] :
    		print ("Negative !!!")
	elif batch_predictions==[2] and data_helpers.neg_word(pre_comment) :  
		print("Comment of you: " + str(comment))
		print("Nagative !!!")	
	else :
